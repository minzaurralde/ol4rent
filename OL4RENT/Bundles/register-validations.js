$(document).ready(function () {
    $("#RegisterForm").validate({
        rules: {
            ...
            ConfirmPassword: { required: true, minlength: 6, maxlength: 100, equalTo: "#Password" }
        },
        messages: {
            ...
            Password: { required: "La contraseña es obligatoria", minlength: "La contraseña debe tener como mínimo {0} caracteres.", maxlength: "La contraseña debe tener como máximo {0} caracteres." },
